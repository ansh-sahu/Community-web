 ...
 if(hs1.getAttribute("email")==null){%>
  ...
  <% }%>
        ...
        <div class="mySlides fade">
            ...
            <img src="img/Online-Distance-Learning-University-Scholarships.jpg" style="width:100%; height:100%;">
            <!-- <div class="text">Caption Text</div> -->
          </div>
          <div class="mySlides fade">
            <div class="numbertext">2 / 3</div>
            <img src="img/community-portal-img.jpg" style="width:100%; height:100%;">
            <!-- <div class="text">Caption Two</div> -->
          </div>
          
          <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
            <img src="img/main-qimg-eed2628dffc726c3d1d4cf190b9262ab.png" style="width:100%; height:100%;">
